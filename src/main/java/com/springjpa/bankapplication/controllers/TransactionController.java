...
public class TransactionController {
	...
	public String transferById(@RequestBody Transaction transaction,@PathVariable Integer userId,@RequestParam Integer transactionParty) {
	return service.transferById(transaction, userId, transactionParty);
	}

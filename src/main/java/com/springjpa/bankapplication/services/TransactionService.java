...
public class TransactionService {
	...
	public Iterable<Transaction> getAllTransactionsByUserId(Integer userId){
		Iterable<Transaction> listOfTransactionsMadeByUser = repository.findByUserId(userId);
		if(listOfTransactionsMadeByUser.equals(null)) {
			throw new TransactionNotFoundException();
		}
		return listOfTransactionsMadeByUser;
	}
}
